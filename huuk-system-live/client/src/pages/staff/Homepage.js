          ...
          <div className={styles["homepage-signin-right-section"]}>
            ...
            >
              ...
              <div style={{ position: "relative" }}>
                ...
                />
                {signInErrors.email && (
                  <div style={{ color: 'red', fontSize: '0.8rem', marginTop: '2px' }}>{signInErrors.email}</div>
                )}
              </div>
          ...
          <div className={styles["homepage-signup-right-section"]}>
            ...
            >
              ...
              <div style={{ position: "relative" }}>
                ...
                />
                {errors.fullname && (
                  <div style={{ color: 'red', fontSize: '0.8rem', marginTop: '2px' }}>{errors.fullname}</div>
                )}
              </div>
              ...
              <div style={{ position: "relative" }}>
                ...
                />
                {errors.username && (
                  <div style={{ color: 'red', fontSize: '0.8rem', marginTop: '2px' }}>{errors.username}</div>
                )}
              </div>
              ...
              <div style={{ position: "relative" }}>
                ...
                />
                {errors.email && (
                  <div style={{ color: 'red', fontSize: '0.8rem', marginTop: '2px' }}>{errors.email}</div>
                )}
              </div>
              ...
              <div style={{ position: "relative" }}>
                ...
                {errors.password && (
                  <div style={{ color: 'red', fontSize: '0.8rem', marginTop: '2px' }}>{errors.password}</div>
                )}
              </div>
              ...
              <div style={{ position: "relative" }}>
                ...
                {errors.confirmPassword && (
                  <div style={{ color: 'red', fontSize: '0.8rem', marginTop: '2px' }}>{errors.confirmPassword}</div>
                )}
              </div>
