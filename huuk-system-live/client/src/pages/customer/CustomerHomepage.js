...
import { MdPhone, MdLock, MdEmail, MdPerson, MdVisibility, MdVisibilityOff, MdOutlineInfo, MdErrorOutline } from 'react-icons/md';
...
const CustomerHomepage = () => {
  ...
  const [isSignInOpen, setSignInOpen] = useState(loginRequired);
  ...
  const handleSignIn = async (e) => {
    ...
    try {
      ...
      if (response.data.success) {
        // Add token to user data before updating profile
        const userWithToken = {
          ...response.data.user,
          token: response.data.token
        };
        // Save to localStorage for booking API
        ...
        setPassword("");
        setSignInErrors({ phoneNumber: "", password: "" });
        console.log("Customer sign-in successful, profile updated and token saved to localStorage");
      } else {
            ...
            <form onSubmit={handleSignIn} className={styles["sign-up-form-homepage"]}>
              ...
              <div style={{ position: "relative" }}>
                ...
                {signInErrors.phoneNumber && (
                  <div style={{ color: 'red', fontSize: '0.8rem', marginTop: '2px' }}>{signInErrors.phoneNumber}</div>
                )}
              </div>
              ...
              <div style={{ position: "relative" }}>
                ...
                {signInErrors.password && (
                  <div style={{ color: 'red', fontSize: '0.8rem', marginTop: '2px' }}>{signInErrors.password}</div>
                )}
              </div>
          ...
          <div className={styles["homepage-signup-right-section"]}>
            ...
            <form className={styles["sign-up-form-homepage"]} onSubmit={handleSignUp}>
              ...
              <div style={{ position: "relative", marginBottom: "18px" }}>
                ...
                {signUpErrors.email && (
                  <div style={{ color: 'red', fontSize: '0.8rem', marginTop: '2px' }}>{signUpErrors.email}</div>
                )}
              </div>
              ...
              <div style={{ position: "relative" }}>
                ...
                {signUpErrors.username && (
                  <div style={{ color: 'red', fontSize: '0.8rem', marginTop: '2px' }}>{signUpErrors.username}</div>
                )}
              </div>
              ...
              <div style={{ position: "relative" }}>
                ...
                {signUpErrors.phoneNumber && (
                  <div style={{ color: 'red', fontSize: '0.8rem', marginTop: '2px' }}>{signUpErrors.phoneNumber}</div>
                )}
              </div>
              ...
              <div style={{ position: "relative" }}>
                ...
                {signUpErrors.password && (
                  <div style={{ color: 'red', fontSize: '0.8rem', marginTop: '2px' }}>{signUpErrors.password}</div>
                )}
              </div>
              ...
              <div style={{ position: "relative" }}>
                ...
                {signUpErrors.confirmPassword && (
                  <div style={{ color: 'red', fontSize: '0.8rem', marginTop: '2px' }}>{signUpErrors.confirmPassword}</div>
                )}
              </div>
