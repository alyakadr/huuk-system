...
const db = mysql.createConnection({
  host: process.env.DB_HOST || "db.ruzentra.com",
  user: process.env.DB_USER || "ruzentra_huukbarber",
  password: process.env.DB_PASSWORD || "huukbarber02@",
  database: process.env.DB_NAME || "ruzentra_huukbarber", // Replace with your actual DB name if different
});
