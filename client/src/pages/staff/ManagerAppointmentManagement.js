...
import { CircularProgress, Dialog, DialogActions, DialogContent, DialogTitle, Typography, Box, Button } from "@mui/material";
          ...
          {appointmentToCancel && (
            <Box sx={{ 
              ...
              <Typography variant="body2" sx={{ mb: 1 }}>
                <strong>Booking ID:</strong> #{String(appointmentToCancel.id).padStart(7, "0")}
              </Typography>
              <Typography variant="body2" sx={{ mb: 1 }}>
                <strong>Service:</strong> {appointmentToCancel.service}
              </Typography>
              <Typography variant="body2" sx={{ mb: 1 }}>
                <strong>Date:</strong> {formatDateForDisplay(appointmentToCancel.date || appointmentToCancel.booking_date)}
              </Typography>
              <Typography variant="body2" sx={{ mb: 1 }}>
                <strong>Time:</strong> {appointmentToCancel.start_time} - {appointmentToCancel.end_time}
              </Typography>
              <Typography variant="body2">
                <strong>Staff:</strong> {appointmentToCancel.username || appointmentToCancel.staffName || 'Unassigned'}
              </Typography>
            </Box>
          )}
        </DialogContent>
