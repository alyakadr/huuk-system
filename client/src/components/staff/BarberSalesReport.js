...
const PIE_COLORS = [
  "#A8D8EA", "#B6E5F0", "#C7E9F4", "#D4F1F8", "#9FD3E7",
  "#8BCBDE", "#7BC4D6", "#6BB6CE", "#5BA8C6", "#4B9ABE",
  "#3B8CB6", "#2B7EAE", "#1B70A6", "#0B629E", "#005496",
];

const BarberSalesReport = () => {
  const [salesData, setSalesData] = useState({ labels: [], data: [], totalSales: 0 });
  ...
  const chartData = {
    ...
    datasets: [
      {
        data: salesData.data || [],
        backgroundColor: (salesData.labels || []).map((_, i) => PIE_COLORS[i % PIE_COLORS.length]),
        borderWidth: 2,
        borderColor: "#1a1a1a",
        hoverBackgroundColor: (salesData.labels || []).map((_, i) => PIE_COLORS[i % PIE_COLORS.length] + "CC"),
        hoverBorderWidth: 3,
  ...
  return (
    <div className="staff-dashboard-barber-sales-report-container">
      <div className="staff-dashboard-barber-sales-report-header">
        <h2 className="staff-dashboard-barber-sales-report-title">Sales Report</h2>
        <button
      ...
      <div className="staff-dashboard-pie-chart">
        {loadingSales ? (
          <div className="staff-dashboard-chart-loading">
            ...
            <p className="staff-dashboard-no-appointments">Loading sales data...</p>
          </div>
          ...
          <div className="staff-dashboard-empty-state">
            ...
            <p className="staff-dashboard-no-appointments">No sales data available</p>
