...
const SimpleCalendar = ({ value, onChange, open, onClose, minDate, shouldDisableDate }) => {
  ...
  const isDateDisabled = (dayObj) => {
    ...
    const isCustomDisabled = shouldDisableDate ? shouldDisableDate(dateToCheck) : false;
        ...
        >
          {days.map((dayObj, index) => (
            <Box
              ...
              sx={{
                height: '32px',
                cursor: dayObj.isCurrentMonth && !isDateDisabled(dayObj) ? 'pointer' : 'default',
                ...
                color: isDateSelected(dayObj) 
                  ...
                  : !dayObj.isCurrentMonth 
                    ...
                    : isDateDisabled(dayObj) 
                      ? '#ddd' 
                      : '#333',
                '&:hover': dayObj.isCurrentMonth && !isDateDisabled(dayObj) ? {
                  backgroundColor: isDateSelected(dayObj) 
                    ? '#5B3BA1' 
                    : '#f5f5f5',
