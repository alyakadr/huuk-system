...
const SignUpModal = ({
  ...
  setSignUpName,
  handleSignUp,
  errors = { phoneNumber: "", password: "", name: "" }, // Default to prevent undefined errors
  setSignUpErrors = () => {}, // Default to no-op function
  loading,
  onShowSignIn, // Function to switch to sign-in modal
}) => {
  const [showPassword, setShowPassword] = useState(false);
  
  // Debug logging
  console.log("SignUpModal render - isOpen:", isOpen);
  console.log("SignUpModal render - errors:", errors);
  console.log("SignUpModal render - loading:", loading);
  console.log("SignUpModal render - phoneNumber:", signUpPhoneNumber);
  console.log("SignUpModal render - password:", signUpPassword ? "[PRESENT]" : "[EMPTY]");
  console.log("SignUpModal render - name:", signUpName);
  
  if (isOpen) {
    console.log("🔴 SIGNUP MODAL IS OPEN - Should be visible!");
  } else {
